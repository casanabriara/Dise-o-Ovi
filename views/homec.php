...
$sql="select * From restbar.productos where tipo_producto ='Platos'";
  ...
  echo "<div class='col-sm-6 col-md-4'>
      <div class='thumbnail'>
        ...
        <div class='caption'>
          ...
          <p>
            <a href='index.php?c=carrito&a=Agregar&id_pruductos=". $fila['id_pruductos'] . "'class='btn btn-primary btn-block ' role='button'><i class='glyphicon glyphicon-shopping-cart'></i> Agregar al carrito</a>
          </p>
        </div>
      </div>
    </div>";
